...
public class SanghapQuiz extends AppCompatActivity implements View.OnClickListener {
    int pos1 = 0;
    int pos2 = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter1 = ArrayAdapter.createFromResource(this, R.array.spinnerArray12,
...
//                GoNext();
        ...
        Button btn = (Button) findViewById(R.id.button_sanghap);
    ...
    private void quizz() {
        String[] sanghapjunbyung = {"甲己", "乙庚", "丙辛", "丁壬", "戊癸"};
//        String[] strMoreLess = {"태과", "불급"};
        ...
        Button btn = (Button) findViewById(R.id.button_sanghap);
        btn.setText(sanghapjunbyung[questionOnDisplay] + "合");
...
/*
        int answer1 = Integer.parseInt(strAnswer);
        Log.i("answer1", Integer.toString(answer1));
*/

        if (pos1 == questionOnDisplay) {
